 ...
 * @author graywatson
 */
public class AndroidLog implements com.android.library.third.ormlite.logger.Log {
	...
	public AndroidLog(String className) {
		...
		int maxLevel = 0;
		for (com.android.library.third.ormlite.logger.Log.Level level : com.android.library.third.ormlite.logger.Log.Level.values()) {
	...
	private int levelToAndroidLevel(com.android.library.third.ormlite.logger.Log.Level level) {
		switch (level) {
			case TRACE :
				return Log.VERBOSE;
			case DEBUG :
