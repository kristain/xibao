 ...
 */
public class StaffStoreSingleListActivity extends SwipeBackActivity {
    ...
    private void initEvent() {
        ...
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("staffname", ((TextView)view.findViewById(R.id.name)).getText().toString());
                intent.putExtra("staff_id", ((TextView)view.findViewById(R.id.adviser_id)).getText().toString());
    ...
    private void loadData() {
       UserParam param= new UserParam();
        param.setUid(bundle.getString("adviser_id"));
        if(!StringUtils.isEmpty(param.getUid())){
            ...
            Toast.makeText(this, "缺少请求参数[u_id]", Toast.LENGTH_LONG).show();
        }
    }
