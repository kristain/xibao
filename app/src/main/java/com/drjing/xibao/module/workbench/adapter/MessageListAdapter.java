...
public class MessageListAdapter extends RecyclerView.Adapter<MessageHolder>{
    ...
    public MessageListAdapter(List<MessageEntity> contents, Context ctx,String type)
    {
        this.ctx = ctx;
        this.type = type;
    ...
    public MessageHolder onCreateViewHolder(ViewGroup parent, final int viewType)
    {
        ...
        return new MessageHolder(view , new MessageHolder.IMyViewHolderClicks()
        {
            ...
            {
                //Toast.makeText(ctx, contents.get((int) caller.getTag()).getMsg(), Toast.LENGTH_LONG).show();
