...
public class StoreAimDetailActivity extends SwipeBackActivity {
    ...
    private void initData() {
        ...
        HttpClient.getTargetIndex(entity, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(String body) {
                ...
                if (HttpClient.RET_SUCCESS_CODE.equals(object.getString("status"))) {
                    ...
                    Toast.makeText(StoreAimDetailActivity.this, "获取失败",
        ...
        }, StoreAimDetailActivity.this,true);
    }
    ...
    private void getSubPersonList(String user_id,final String rolekey){
        ...
        if(!StringUtils.isEmpty(param.getUid())){
                    ...
                    if (HttpClient.RET_SUCCESS_CODE.equals(object.getString("status"))) {
                        ...
                        if (list != null && list.size() > 0) {
                            ...
                            if (RoleEnum.CONSULTANT.getCode().equals(rolekey)) {
                                UIHelper.showStaffAimDetail(StoreAimDetailActivity.this, bundle);
                            } else if (RoleEnum.STOREMANAGER.getCode().equals(rolekey)) {
                                UIHelper.showAdviserAimDetail(StoreAimDetailActivity.this, bundle);
                            } else if (RoleEnum.AREAMANAGER.getCode().equals(rolekey)) {
                                UIHelper.showStoreAimDetail(StoreAimDetailActivity.this, bundle);
                            } else if (RoleEnum.BOSS.getCode().equals(rolekey)) {
                                UIHelper.showAreaManagerAimDetail(StoreAimDetailActivity.this, bundle);
                            }
                        } else {
                            Toast.makeText(StoreAimDetailActivity.this, "没有其他用户", Toast.LENGTH_LONG).show();
                        }
                    } else if(HttpClient.UNLOGIN_CODE.equals(object.getString("status"))) {
                        UIHelper.showLogin(StoreAimDetailActivity.this);
                    }else {
            ...
            Toast.makeText(StoreAimDetailActivity.this, "缺少请求参数[uid]", Toast.LENGTH_LONG).show();
        }
