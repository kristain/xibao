 ...
 */
public class StaffAimDetailActivity extends SwipeBackActivity {
    ...
    private void initView() {
        ...
        adapter = new QuickAdapter<TargetEntity>(this, R.layout.aimdetail_item) {
            @Override
            protected void convert(BaseAdapterHelper helper, TargetEntity item) {
                JSONObject account = JSON.parseObject(item.getAccount());
    ...
    private void initData() {
        ...
        HttpClient.getTargetIndex(entity, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(String body) {
                ...
                if (HttpClient.RET_SUCCESS_CODE.equals(object.getString("status"))) {
                    ...
                    UIHelper.showLogin(StaffAimDetailActivity.this);
                }else {
                    Toast.makeText(StaffAimDetailActivity.this, "获取失败",
        ...
        }, StaffAimDetailActivity.this,true);
    }
