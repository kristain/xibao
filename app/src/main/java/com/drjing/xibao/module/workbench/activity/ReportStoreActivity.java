 ...
 */
public class ReportStoreActivity extends SwipeBackActivity {

    private static final String TAG="ReportStoreActivity";
    /**
     * 后退按钮
     */
    ...
    private void initEvent() {
        ...
        store_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                UIHelper.showStoreReportList(ReportStoreActivity.this,bundle);
            }
        });
            ...
            HttpClient.getCompanyStoreList(param, new AsyncHttpResponseHandler() {
                ...
                public void onSuccess(String body) {
                    ...
                    if (HttpClient.RET_SUCCESS_CODE.equals(object.getString("status"))) {
                        ...
                        UIHelper.showLogin(ReportStoreActivity.this);
                    }else {
