...
import com.drjing.xibao.module.workbench.adapter.CustomerPagerAdapter;
 ...
 */
public class CustomerListActivity extends SwipeBackActivity {
    ...
    private CustomerPagerAdapter mCustomerPagerAdapter;
    ...
    void initView() {
        ...
        search_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UIHelper.showCustomerSearch(CustomerListActivity.this, REQUESTCODE);
            }
        });
    }
            ...
            case REQUESTCODE:
                if (intent != null) {
                    ...
                    if (!StringUtils.isEmpty(b.getString("name")) || !StringUtils.isEmpty(b.getString("mobile"))) {
                        ...
                        try {
                            if (!dbHelper.isOpen()) {
                                dbHelper = DatabaseHelper.gainInstance(CustomerListActivity.this, AppConfig.DB_NAME, AppConfig.DB_VERSION);
                                searchDao = (Dao<SearchParam, String>) dbHelper.getDao(SearchParam.class);
                            }
