...
import com.drjing.xibao.module.workbench.adapter.StoreCustomerPagerAdapter;
 ...
 */
public class StoreCustomerListActivity extends SwipeBackActivity {
    ...
    private StoreCustomerPagerAdapter mCustomerPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_storecustomer_list);
    ...
    void initView() {
        ...
        mCustomerPagerAdapter= new StoreCustomerPagerAdapter(getSupportFragmentManager());
        ...
        search_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UIHelper.showCustomerSearch(StoreCustomerListActivity.this, REQUESTCODE);
            }
        });
        ...
        btnRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UIHelper.showUnAssignCustomList(StoreCustomerListActivity.this, bundle);
            }
        });
    }
        ...
        public void onPageSelected(int position) {
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    mGroup.check(R.id.service_customer);
                    break;
                case 2:
        ...
        switch (requestCode) {
            case REQUESTCODE:
                if (intent != null) {
                    ...
                    Log.e("TAG", "name:" + b.getString("name")+"checkedPos:"+checkedPos);
                    if (!StringUtils.isEmpty(b.getString("name")) || !StringUtils.isEmpty(b.getString("mobile"))) {
                        ...
                        try {
                            if (!dbHelper.isOpen()) {
                                dbHelper = DatabaseHelper.gainInstance(StoreCustomerListActivity.this, AppConfig.DB_NAME, AppConfig.DB_VERSION);
                                searchDao = (Dao<SearchParam, String>) dbHelper.getDao(SearchParam.class);
                            }
