...
import com.drjing.xibao.common.view.materialviewpager.header.HeaderDesign;
import com.drjing.xibao.common.view.materialviewpager.header.MaterialViewPagerImageHelper;
...
public class MaterialViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    protected void onFinishInflate() {
        ...
        if (isInEditMode()) { //preview titlestrip
            ...
            settings.pagerTitleStripId = R.layout.material_view_pager_tools_pagertitlestrip;
        }
        ...
        if (!isInEditMode()) {
            ...
            View sample = LayoutInflater.from(getContext()).inflate(R.layout.material_view_pager_tools_list_items, pagerTitleStripContainer, false);
