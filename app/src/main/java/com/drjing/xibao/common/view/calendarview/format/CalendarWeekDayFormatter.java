...
import com.drjing.xibao.common.view.calendarview.CalendarUtils;
...
public class CalendarWeekDayFormatter implements WeekDayFormatter {
    ...
    public CharSequence format(int dayOfWeek) {
        ...
        return calendar.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.SHORT, Locale.getDefault()).substring(1);
    }
}
