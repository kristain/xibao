...
public class TagView extends View {
    ...
    private void init(String text){
        ...
        mBitmap =  ((BitmapDrawable) getResources().getDrawable(R.drawable.icon_tag_add)).getBitmap();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(mBitmap,getWidth()-mBitmap.getWidth(),getHeight()-mBitmap.getHeight(),mPaint);
    }
