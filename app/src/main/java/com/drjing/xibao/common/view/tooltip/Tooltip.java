package com.drjing.xibao.common.view.tooltip;
...
import static com.drjing.xibao.common.view.tooltip.Utils.log;
...
public final class Tooltip {
    ...
    static class TooltipViewImpl extends ViewGroup implements TooltipView {
        ...
        private void initializeView () {
            ...
            mTextView2 = (TextView) mView.findViewById(android.R.id.text2);
            String[] str =((String) this.mText).split(",");

            mTextView.setText(Html.fromHtml(str[1]));
            mTextView2.setText(Html.fromHtml(str[0]));

            if (mMaxWidth > -1) {
                Log.e("TAG", "mMaxWidth:" + mMaxWidth);
                mTextView.setMaxWidth(mMaxWidth);
                mTextView2.setMaxWidth(mMaxWidth);
                mTextView.setWidth(mMaxWidth);
                mTextView2.setWidth(mMaxWidth);
        ...
        private void startFloatingAnimations () {
            ...
            if (mFloatingAnimation.direction == 0) {
                direction = mGravity == Gravity.TOP || mGravity == Gravity.BOTTOM ? 2 : 1;
            } else {
