package com.drjing.xibao.common.view.tagview;
 ...
 */
public class TagNoOpertContainerLayout extends ViewGroup {
    ...
    /** TagNoOpertContainerLayout border width(default 0.5dp)*/
    private float mBorderWidth = 0f;

    /** TagNoOpertContainerLayout border radius(default 10.0dp)*/
    private float mBorderRadius = 0f;

    /** The sensitive of the ViewDragHelper(default 1.0f, normal)*/
    private float mSensitivity = 1.0f;

    /** TagNoneView average height*/
    private int mChildHeight;

    /** TagNoOpertContainerLayout border color(default #22FF0000)*/
    private int mBorderColor = Color.parseColor("#FFFEFFFF");

    /** TagNoOpertContainerLayout background color(default #11FF0000)*/
    private int mBackgroundColor = Color.parseColor("#FFFEFFFF");

    /** The container layout gravity(default left)*/
    private int mGravity = Gravity.LEFT;

    /** The max length for TagNoneView(default max length 23)*/
    private int mTagMaxLength = 23;

    /** TagNoneView Border width(default 0.5dp)*/
    private float mTagBorderWidth = 0.5f;

    /** TagNoneView Border radius(default 15.0dp)*/
    private float mTagBorderRadius = 3f;

    /** TagNoneView Text size(default 14sp)*/
    ...
    /** Horizontal padding for TagNoneView, include left & right padding(left & right padding are equal, default 20px)*/
    private int mTagHorizontalPadding = 20;

    /** Vertical padding for TagNoneView, include top & bottom padding(top & bottom padding are equal, default 17px)*/
    private int mTagVerticalPadding = 17;

    /** TagNoneView border color(default #88F44336)*/
    private int mTagBorderColor = Color.parseColor("#FFd1d1d2");

    /** TagNoneView background color(default #33F44336)*/
    private int mTagBackgroundColor = Color.parseColor("#FFFEFFFF");

    /** TagNoneView text color(default #FF666666)*/
    private int mTagTextColor = Color.parseColor("#FF666666");

    /** TagNoneView typeface*/
    private Typeface mTagTypeface = Typeface.DEFAULT;

    /** Whether TagNoneView can clickable(default unclickable)*/
    private boolean isTagViewClickable;

    /** Tags*/
    private List<String> mTags;

    /** Can drag TagNoneView(default false)*/
    private boolean mDragEnable;

    /** TagNoneView drag state(default STATE_IDLE)*/
    ...
    /** OnTagClickListener for TagNoneView*/
    private TagNoneView.OnTagClickListener mOnTagClickListener;
    ...
    public TagNoOpertContainerLayout(Context context) {
        this(context, null);
    }

    public TagNoOpertContainerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TagNoOpertContainerLayout(Context context, AttributeSet attrs, int defStyleAttr){
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    private void onAddTag(String text, int position) {
        ...
        TagNoneView tagView = new TagNoneView(getContext(), text);
        initTagView(tagView);
    ...
    private void initTagView(TagNoneView tagView){
     ...
     * @param listener
     */
    public void setOnTagClickListener(TagNoneView.OnTagClickListener listener){
    ...
    /**
     * Get a string list for all tags in TagNoOpertContainerLayout.
     * @return
     */
    public List<String> getTags(){
        List<String> tmpList = new ArrayList<String>();
        for (View view : mChildViews){
            if (view instanceof TagNoneView){
                tmpList.add(((TagNoneView) view).getText());
            }
        }
        return tmpList;
    }
    ...
    /**
     * Get TagNoOpertContainerLayout border width.
     * @return
     */
    ...
    /**
     * Set TagNoOpertContainerLayout border width.
     * @param width
     */
    ...
    /**
     * Get TagNoOpertContainerLayout border radius.
     * @return
     */
    ...
    /**
     * Set TagNoOpertContainerLayout border radius.
     * @param radius
     */
    ...
    /**
     * Get TagNoOpertContainerLayout border color.
     * @return
     */
    ...
    /**
     * Set TagNoOpertContainerLayout border color.
     * @param color
     */
    ...
    /**
     * Get TagNoOpertContainerLayout background color.
     * @return
     */
    ...
    /**
     * Set TagNoOpertContainerLayout background color.
     * @param color
     */
    ...
    /**
     * Get TagNoOpertContainerLayout ViewDragHelper sensitivity.
     * @return
     */
    ...
    /**
     * Set TagNoOpertContainerLayout ViewDragHelper sensitivity.
     * @param sensitivity
     */
    ...
    /**
     * Get TagNoneView vertical padding.
     * @return
     */
    ...
    /**
     * Set TagNoneView vertical padding.
     * @param padding
     */
    ...
    /**
     * Get TagNoneView background color.
     * @return
     */
    ...
    /**
     * Set TagNoneView background color.
     * @param color
     */
