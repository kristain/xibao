...
import com.drjing.xibao.common.view.calendarview.format.ArrayWeekDayFormatter;
import com.drjing.xibao.common.view.calendarview.format.DateFormatTitleFormatter;
import com.drjing.xibao.common.view.calendarview.format.DayFormatter;
import com.drjing.xibao.common.view.calendarview.format.MonthArrayTitleFormatter;
import com.drjing.xibao.common.view.calendarview.format.TitleFormatter;
import com.drjing.xibao.common.view.calendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        title.setBackgroundResource(R.drawable.edittext_drawable);
        ...
        isDialog = a.getDimensionPixelSize(R.styleable.MaterialCalendarView_mcv_tileSize, 1);

        Log.e("CalendarViewTAG",isDialog+"");
        setupChildren();
    ...
    private void setupChildren() {
        ...
        Drawable myImage = res.getDrawable(R.drawable.icon_mbkb_previous);
        buttonPast.setCompoundDrawablesWithIntrinsicBounds(myImage, null, null, null);
        buttonPast.setButtonDrawable(R.drawable.mcv_action_previous);
        buttonPast.setBackgroundResource(R.drawable.mcv_action_previous);
        buttonPast.setText("上月");
        buttonPast.setGravity(Gravity.CENTER);
        LinearLayout.LayoutParams buttonPast_layout= new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 2);
        buttonPast_layout.setMargins(-30, 0, 0, 0);

        topbar.addView(buttonPast, buttonPast_layout);
        ...
        if(isDialog==0){
            ...
            params.setMargins(100, 10, 50, 10);
        }

        title.setGravity(Gravity.CENTER);
        topbar.addView(title, params);

        Drawable rightImage = res.getDrawable(R.drawable.icon_mbkb_next);
        //buttonFuture.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        buttonFuture.setCompoundDrawablesWithIntrinsicBounds(null, null, rightImage, null);
        buttonFuture.setButtonDrawable(R.drawable.mcv_action_next);
        buttonFuture.setBackgroundResource(R.drawable.mcv_action_next);
        buttonFuture.setText("下月");
        buttonFuture.setGravity(Gravity.CENTER);
        LinearLayout.LayoutParams buttonFuture_layout= new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 2);
        buttonFuture_layout.setMargins(0, 0, 30, 0);

        topbar.addView(buttonFuture,buttonFuture_layout);
    ...
    public void setArrowColor(int color) {
        ...
        buttonPast.setTextColor(color);
        buttonFuture.setTextColor(color);
        invalidate();
    }
    ...
    public void setLeftArrowMask(Drawable icon) {
        ...
        buttonPast.setBackgroundDrawable(icon);
    }
    ...
    public void setRightArrowMask(Drawable icon) {
       ...
       // buttonFuture.setImageDrawable(icon);
        buttonFuture.setBackgroundDrawable(icon);
    }
    ...
    public void setCurrentDate(@Nullable CalendarDay day, boolean useSmoothScroll) {
        ...
        dispatchOnDateSelected(day, true);
        updateUi();
    }
    ...
    /**
     * Set a {@linkplain com.drjing.xibao.common.view.calendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.drjing.xibao.common.view.calendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.drjing.xibao.common.view.calendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.drjing.xibao.common.view.calendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.drjing.xibao.common.view.calendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.drjing.xibao.common.view.calendarview.format.TitleFormatter)
     */
