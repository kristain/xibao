...
import static com.drjing.xibao.common.view.calendarview.MaterialCalendarView.SHOW_DEFAULTS;
...
class MonthView extends ViewGroup implements View.OnClickListener {
    ...
    public MonthView(@NonNull MaterialCalendarView view, CalendarDay month, int firstDayOfWeek) {
        ...
        for (int i = 0; i < DEFAULT_DAYS_IN_WEEK; i++) {
            ...
            weekDayView.setBackgroundResource(R.drawable.dayview_drawable);
           //TODO
            ...
            if(mcv.getIsDialog()==0){
                weekDayView.setPadding(25, 20, 25, 20);
            }else{
                weekDayView.setPadding(35, 30, 35, 30);
            }

            linearLayout.addView(weekDayView,lp);
        ...
        for (int r = 0; r < DEFAULT_MAX_WEEKS; r++) {
            for (int i = 0; i < DEFAULT_DAYS_IN_WEEK; i++) {
                ...
                if(mcv.getIsDialog()==0){
                    dayView.setPadding(25, 20, 25, 20);
                }else{
                    dayView.setPadding(35,30,35,30);
                }

                linearLayout.addView(dayView,lp);
