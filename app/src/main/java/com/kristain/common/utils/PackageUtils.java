...
public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath,
        ...
        com.kristain.common.utils.ShellUtils.CommandResult commandResult = ShellUtils.execCommand(
    ...
    public static int getInstallLocation() {
        com.kristain.common.utils.ShellUtils.CommandResult commandResult = ShellUtils
                .execCommand(
